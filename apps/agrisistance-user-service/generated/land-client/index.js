...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\STORM Tech\\Desktop\\Code\\A2SV\\A2SV-Agrisistance-microservice\\apps\\agrisistance-user-service\\generated\\land-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\STORM Tech\\Desktop\\Code\\A2SV\\A2SV-Agrisistance-microservice\\apps\\agrisistance-user-service\\prisma\\schema.land.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../.env",
  ...
  "inlineSchemaHash": "116955b14743f4846c1e09eeacf94550f76d3212ef364e1c2881e53aba661889",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/agrisistance-user-service/generated/land-client",
    "agrisistance-user-service/generated/land-client",
  ]
...
path.join(process.cwd(), "apps/agrisistance-user-service/generated/land-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/agrisistance-user-service/generated/land-client/schema.prisma")
